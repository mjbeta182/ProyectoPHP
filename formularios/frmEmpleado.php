	...
	<div class="row3">
        ...
        <strong>EMPLEADO</strong>
          ...
          <label class="sr-only" for="user">Codigo</label>
            ...
            <button type="submit" class="btn btn-warning" onclick="javascript:frmImprimirReporte(url);">Imprimir Reporte</button>
            <button type="submit" class="btn btn-warning">Cancelar</button>
          </form>
        </div><!--fin de col-md-4-->
        <div class="col-md-8">  
            <table border="1" class="tabla">
              <?php mostrarDatos($bdConexion,$hCodigo,$txtNombre,$txtDireccion,$txtTelefono,$slcTipoUsuario,$txtEmail,$txtContrasena); ?>
            </table>
      </div>
    </div><!--fin de row-->
  </div>
